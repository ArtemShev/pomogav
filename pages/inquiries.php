            ...
            <?php
                ...
                if($shelter!=0){
                    do{
                        ...
                        // echo "<img src='data:image/png;base64,".base64_encode($shelter['image'])."'>";
                ...
                //     $inquiry = mysqli_fetch_assoc($result2);
                //     // echo "<img src='data:image/png;base64,".base64_encode($shelter['image'])."'>";
                //     printf("<div class='shelter'><img class='shelter-img' src='".$shelter['imagepath'].$shelter['imagename']."'><div class='shelter-filling'><span class='shelter-name'>".stripQuotes($shelter['shelter_name'])."</span><p class='shelter-description'>Описание приюта: ".stripQuotes($shelter['description'])."</p><div class='link-wrapper'><span class='last-inq'>Последний запрос: ".stripQuotes($inquiry['description'])." </span><a href='../pages/shelter_page.php?shelter_id={$shelter['id']}' class='shelter-link'>Подробнее ❯❯</a></div></div></div>");
                // }
            ?>
        </section>
    </main>
